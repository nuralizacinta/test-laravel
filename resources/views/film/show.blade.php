            ...
            <div class="card">
              <div class="card-header p-2">
                <ul class="nav nav-pills ">   
                  ...
                  <a href="{{ route('kritik.create', ['id' => $film]) }}" class="btn btn-primary btn-block">Add Kritik  <i class="fas fa-plus-square"></i></a>
                </ul>
              </div><!-- /.card-header -->
              <div class="card-body">
                  ...
                  <div class="active tab-pane" id="activity">
                    ...
                    <div class="post">
                      <div class="user-block">
                        <img class="img-circle img-bordered-sm" src="{{ asset('adminlte/dist/img/iu.jpg') }}" alt="user image">
                        <span class="username">
                        ...
                        <span class="description">Shared publicly - 7:30 today</span>
                      </div>
                      <!-- /.user-block -->
                      <p class="text-muted">
